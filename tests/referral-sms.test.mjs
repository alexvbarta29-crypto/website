...
test("mode all: friend, office, and referrer texts with the verbatim templates", async () => {
  ...
  assert.equal(referrer.params.get("Body"),
    `Thanks for referring 1 friend(s) to Barta Window Washing! You earn a $50 credit (or a $25 gift card) for each one who books. Track your referrals: https://www.bartawindowwashing.com/refer.html?t=${out.token}`);
