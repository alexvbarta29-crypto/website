...
SERVICES = [
    ...
    },
    {
        ...
        "benefits": [
            ...
            ("Every sill &amp; track detailed", "We hand-wipe the parts most companies skip."),
            ("Flexible scheduling", "We work around your household — pets, kids, and all."),
        ],
        "intro": "Interior glass collects fingerprints, dust, and haze that exterior-only cleaning never touches — and it's the view you actually live with every day. Barta hand-details interior panes, frames, sills, and tracks room by room, using drop cloths and careful technique so your floors and furnishings stay protected the whole time.",
        "includes": [
            "Interior glass hand-cleaned and squeegeed",
            "Interior sills, tracks, and frames wiped down",
