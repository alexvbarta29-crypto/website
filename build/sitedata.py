...
SERVICES = [
    ...
    },
    {
        ...
        "includes": [
            "Roofs, stucco, and other delicate painted surfaces",
        ...
        "faqs": [
            ("What surfaces need soft washing instead of pressure washing?",
             "Roofs, stucco, screens, and other painted or delicate surfaces should always be soft washed rather than pressure washed."),
